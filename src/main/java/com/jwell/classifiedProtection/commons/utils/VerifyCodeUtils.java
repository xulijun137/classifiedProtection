...
public class VerifyCodeUtils {
    ...
    public static final String CHAR_VERIFY_CODES = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
     ...
     * @return
     */
    public static String generateCharVerifyCode(int verifySize) {
        return generateVerifyCode(verifySize, CHAR_VERIFY_CODES);
    }
    ...
    public static void main(String[] args) throws IOException {
        logger.info("do create verify code...");
        File dir = new File("D:/verifies");
        int w = 200, h = 80;
        for (int i = 0; i < 1; i++) {
            String verifyCode = generateNumberVerifyCode(4);
